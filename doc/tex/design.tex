...
\textbf{Определение}. Условие корректности изоморфизма $I$ между графами
$G_p = (V_p, L_p, E_p)$ и $G_t = (V_t, L_t, E_t)$:
%
$$(\forall (p, t) \in I)$$
$$( (\forall (p, p_x, l) \in E_p)(\exists (t, t_y, l) \in E_t: (p_x, t_y) \in I) \land (\forall (p_a, p, l) \in E_p)(\exists (t_b, t, l) \in E_t: (p_a, t_b) \in I) )$$
